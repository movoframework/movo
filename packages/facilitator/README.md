...
The service tier of a self-hostable Stellar x402 facilitator: signer pool, channel accounts, metering, rate limiting and readiness over @x402/stellar.

The service tier of a self-hostable Stellar x402 facilitator over `@x402/stellar`: the sponsor signer pool, channel accounts, metering, rate limiting and readiness. A sponsor account is leased one settlement at a time — a Stellar account's sequence number makes it a mutex, not a weight.

## Install

```bash
pnpm add @movoframework/facilitator
```
